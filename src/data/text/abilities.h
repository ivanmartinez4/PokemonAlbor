...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_STATIC] = _("Elect. estática"),
    [ABILITY_VOLT_ABSORB] = _("Absorbe elect."),
    ...
    [ABILITY_COLOR_CHANGE] = _("Cambiacolor"),
    ...
    [ABILITY_SHED_SKIN] = _("Cambia pieles"),
    ...
    [ABILITY_STANCE_CHANGE] = _("Cambio tátctico"),
    ...
    [ABILITY_PIXILATE] = _("Piel féerica"),
    ...
    [ABILITY_SOUL_HEART] = _("Alma-corazón"),
    ...
    [ABILITY_MIRROR_ARMOR] = _("Coraza espejo"),
    ...
    [ABILITY_SAND_SPIT] = _("Escupe arena"),
    ...
    [ABILITY_WANDERING_SPIRIT] = _("Espíritu errante"),
    [ABILITY_GORILLA_TACTICS] = _("Táctica gorila"),
    ...
    [ABILITY_ZERO_TO_HERO] = _("Cambio heróico"),
    [ABILITY_COMMANDER] = _("Comandante"),
    [ABILITY_ELECTROMORPHOSIS] = _("Electromorfósis"),
    [ABILITY_PROTOSYNTHESIS] = _("Protosíntesis"),
    [ABILITY_QUARK_DRIVE] = _("Carga quark"),
    [ABILITY_GOOD_AS_GOLD] = _("Cuerpo áureo"),
    [ABILITY_VESSEL_OF_RUIN] = _("Caldero Decable"),
    [ABILITY_SWORD_OF_RUIN] = _("Espada Decable"),
    [ABILITY_TABLETS_OF_RUIN] = _("Tablilla Debacle"),
    [ABILITY_BEADS_OF_RUIN] = _("Abalorio Decable"),
    [ABILITY_ORICHALCUM_PULSE] = _("Latido Oricalco"),
    [ABILITY_HADRON_ENGINE] = _("Motor Hadrónico"),
    [ABILITY_OPPORTUNIST] = _("Oportunista"),
    [ABILITY_CUD_CHEW] = _("Rumiante"),
    ...
    [ABILITY_EARTH_EATER] = _("Cometierra"),
